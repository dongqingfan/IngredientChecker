...
function initRuntimeSocketService() {
  const hosts = "192.168.31.221,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_KuoTXO";
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","192.168.31.221"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/software/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"schedule","spaceId":"mp-ed020ef2-17df-422a-b8aa-20731df4346f","clientSecret":"hZ8RHCLUFg4dqpt17hHwSw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__C6008BB";
} catch (e2) {
